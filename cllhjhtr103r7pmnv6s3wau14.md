...
cuid: cllhjhtr103r7pmnv6s3wau14
slug: a-web-application-that-generates-stable-images-based-on-user-prompts-using-various-ai-models-1
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1692420537160/caf27cb2-3773-4335-b702-6ad8d62c5954.jpeg
...
# New UI coming soon!
 ![A web application that generates stable images based on user prompts using various AI models](https://cdn.hashnode.com/res/hashnode/image/upload/v1692420537160/caf27cb2-3773-4335-b702-6ad8d62c5954.jpeg)
...
![A web application that generates stable images based on user prompts using various AI models](https://cdn.hashnode.com/res/hashnode/image/upload/v1692420540842/c376f7ad-5904-47aa-9c72-90d8d6d6eb28.png)
